...
public class DistributoriDiBenzina implements Comparable{
	...
	public DistributoriDiBenzina(String citta, String proprietario, int capacita) { //inizialmente ogni distributore non contiene benzina
		super();
		this.citta = citta;
...
//	@Override
//	public int compareTo(DistributoriDiBenzina d) { //differenza di capacità tra 2 distributori
...
//	}
	...
	public int compareTo(DistributoreDiBenzina d) {
		return (this.capacita-d.getCapacita());
	}
