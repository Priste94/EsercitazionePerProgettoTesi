		...
		while(scelta2!=1){
			...
			switch(scelta){
				case 1:
					...
					T[scelta].getContenuta()+" litri: ");
					T[scelta].erogazioneCarburante(scanner.nextInt());
			
					System.out.printf("Vuoi continuare?\nDigita 0 per confermare oppure 1 per negare: ");
					scelta2=scanner.nextInt();
					break;
				case 2:
					System.out.printf("il distrubutore contiene "+T[scelta].getContenuta()+" su "+T[ch].getCapacita());
